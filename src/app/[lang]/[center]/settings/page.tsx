                                    ...
                                    <div className='w-full flex flex-col gap-2 items-start justify-start'>
                                        ...
                                        <div className='flex flex-row gap-2 items-center justify-between'>
                                            ...
                                            <button
                                                ...
                                                className={`bg-[#0047ab] text-zinc-100 rounded-lg p-2 ${!editedNickname ? "opacity-50" : ""}`}
                                                onClick={() => {
                                                    if (!editedNickname) {
                            ...
                            <div className='w-full flex flex-col items-start justify-center gap-2
                                ...
                                <div className='w-full flex flex-row items-center justify-between gap-2'>
                                    ...
                                    <button
                                        ...
                                        className={`bg-[#0047ab] text-zinc-100 rounded-lg p-2 ${!storeDescription ? "opacity-50" : ""}`}
                                        onClick={() => {
                                            if (!storeDescription) {
                            ...
                            <div className='w-full flex flex-col items-start justify-center gap-2'>
                                ...
                                <div className="w-full flex flex-col xl:flex-row items-center justify-center gap-2">
                                    ...
                                    <div className="flex flex-row items-center justify-center gap-2">
                                        ...
                                        {store && store.storeName}의 회원이 없습니다.
                                        <br />
                                       가맹점 텔레그램 봇에서 회원가입 후 가맹점 수수료 USDT지갑을 설정하세요.
                                        </span>
                                    </div>
                                    )}
                                </div>
                            ...
                            <div className='w-full flex flex-col items-center justify-between gap-2'>
                                ...
                                <div className='hidden w-full flex-row items-center justify-start gap-2'>
                                    ...
                                    <button
                                        ...
                                        className={`bg-[#0047ab] text-zinc-100 rounded-lg p-2 ${!bankName || !accountNumber || !accountHolder ? "opacity-50" : ""}`}
                                        onClick={() => {
