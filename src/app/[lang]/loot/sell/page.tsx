  ...
  return (
    ...
    <main className="orangex-sell-light p-4 pb-28 min-h-[100vh] flex items-start justify-center container max-w-screen-2xl mx-auto bg-[linear-gradient(160deg,#fff4ea,#f0f9ff_45%,#fff1f2_85%)] text-slate-900">
      ...
      <div className="py-0 w-full">
        ...
        rounded-2xl border border-orange-600/40 bg-gradient-to-r from-orange-600 to-amber-500 p-3
        shadow-[0_24px_60px_-40px_rgba(15,23,42,0.35)] backdrop-blur
        mb-4">
            ...
            <div className="fixed left-0 right-0 bottom-4 z-30 px-4 pb-[env(safe-area-inset-bottom)]">
              <div className="mx-auto w-full max-w-screen-2xl">
                ...
                <div className="flex flex-col items-center justify-center gap-1 rounded-2xl border border-orange-400/40 bg-gradient-to-br from-orange-600 to-amber-500 px-2 py-2 text-white shadow-[0_16px_40px_-28px_rgba(249,115,22,0.8)]">
                  ...
                  <span className="text-[11px] font-semibold text-white">판매하기</span>
                </div>
                ...
                >
                  ...
                  <span className="text-[11px] font-semibold text-slate-700">구매하기</span>
                </button>
                  </div>
                </div>
              </div>
                    ...
                    <div className="w-full xl:basis-full flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200/80 bg-slate-50 px-3 py-2">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {seller.seller?.usdtToKrwRate && (
                          <div className="flex flex-col items-center justify-center gap-1 rounded-xl border border-slate-200/80 bg-white px-3 py-2 shadow-sm">
                        ...
                        <div className="w-full flex flex-col items-start justify-center gap-2">
                          ...
                          */}
                          ...
                          <div className="w-full flex flex-row items-center justify-between gap-2">    
                            ...
                            <button
                              className="flex items-center justify-center gap-2
                              rounded-full border border-slate-200/70 bg-white/90 p-1 shadow-sm
                              hover:bg-slate-50 hover:cursor-pointer hover:scale-105
                            ...
                            <div className="w-full flex flex-col items-center justify-center gap-2">
                              ...
                              <div className="w-full flex flex-row items-center justify-right gap-2">
                                <Image
                                  ...
                                  className="w-5 h-5"
                                />
                                <span className="text-3xl xl:text-2xl text-slate-900 font-semibold tabular-nums"
                                  style={{ fontFamily: 'monospace' }}>
                                  {
                              ...
                              {seller.walletAddress === address && (
                                <div className="w-28 flex flex-col items-center justify-center gap-1">
                                  ...
                                  <input
                                    ...
                                    min="1"
                                    placeholder="충전금액"
                                    className="w-full bg-slate-50 border border-slate-200 text-slate-700 rounded-lg p-1 text-xs text-center
                                  ...
                                  <button
                                    ...
                                    className="w-full text-xs text-white bg-slate-900 hover:bg-slate-800 px-2 py-1 rounded-lg
                          ...
                          <div className="w-full flex flex-row items-center justify-start gap-2">
                            ...
                            */}
                            ...
                            <div className="flex flex-col items-start justify-center ml-4 gap-1">
                              ...
                              <span className="w-full flex text-sm font-semibold text-slate-700">
                                자동입금처리
                              </span>
                              {seller.seller?.autoProcessDeposit ? (
                                <div className="w-full flex flex-col items-center justify-center">
                                  <div className="flex text-xs text-emerald-700 font-semibold
                                  bg-emerald-50 border border-emerald-200/80 rounded-lg px-2 py-1 text-center
                                  ">
                                    활성화 상태
                                  </div>
                                  {/* 설명 */}
                                ...
                                <div className="w-full flex flex-col items-center justify-center">
                                  <div className="flex text-xs text-rose-700 font-semibold
                                  bg-rose-50 border border-rose-200/80 rounded-lg px-2 py-1 text-center
                                  ">
                                    비활성화 상태
                                  </div>
                                  {/* 설명 */}
                        ...
                        border border-amber-200/70 shadow-[0_18px_40px_-24px_rgba(180,83,9,0.35)]">
                          ...
                          {seller.seller?.buyOrder?.buyer?.walletAddress === address && (
                              ...
                              ">
                                ...
                                <div className="mt-2 inline-flex items-center gap-2 rounded-lg border border-rose-200/80 bg-rose-50 px-3 py-2 text-sm font-semibold text-rose-700 shadow-sm">
                    ...
                    <div className="
                      ...
                      {seller.seller?.buyOrder?.status === 'paymentRequested' ? (
                        <div className="w-full flex flex-col items-start justify-center gap-2">
                          ...
                          <div className="w-full flex flex-row items-center justify-start gap-2">
                            <div className="flex flex-row items-center gap-2
                            bg-rose-50 text-rose-700 px-3 py-2 rounded-lg border border-rose-200">
                              <span className="text-sm font-semibold">
                                판매 진행중
                              </span>
                            </div>
                        ...
                        <div className="w-full flex flex-col items-start justify-center gap-2">
                            ...
                            <div className="w-full flex flex-col items-start justify-center gap-2">
                              ...
                              {seller.walletAddress === address && (
                                <div className="w-full flex flex-col items-start justify-center gap-1">
                                  <input
                                    type="text"
                                    className="w-full border border-slate-200 bg-white text-slate-800 rounded-lg p-2 text-xs
                          ...
                          <div className={'w-full flex flex-col items-start justify-center gap-2'}>
                            ...
                            p-3 bg-emerald-50 border border-emerald-200/80 rounded-lg
                            ">
                              ...
                              <div className="w-full flex flex-col items-end justify-center gap-1">
                                ...
                                <span className="text-lg text-slate-700 tabular-nums"
                                  style={{ fontFamily: 'monospace' }}>
                            ...
                            <div className="w-full flex flex-row items-center justify-between gap-2
                            p-3 bg-rose-50 border border-rose-200/80 rounded-lg
                            ">
                              <div className="w-20 flex flex-col items-start justify-center gap-0">
                                <span className="text-sm text-slate-700">
                                  중재거래
                              ...
                              <div className="w-full flex flex-col items-end justify-center gap-1">
                                <span className="text-lg text-rose-700 tabular-nums"
                                  style={{ fontFamily: 'monospace' }}>
                      ...
                      ? (
                        ...
                        <div className={`
                          ...
                          ${seller.seller?.buyOrder?.buyer?.walletAddress === address
                          ? 'relative rounded-xl border-2 border-blue-500/70 bg-blue-50/80 p-3 shadow-[0_20px_50px_-30px_rgba(37,99,235,0.5)] ring-1 ring-blue-200/60'
                          : ''
                          }
                          `}>
                          ...
                          {seller.seller?.buyOrder?.buyer?.walletAddress === address && (
                            <div className="w-full flex items-center gap-2 rounded-lg border border-blue-500/40
                              bg-gradient-to-r from-blue-600 via-sky-500 to-cyan-400 px-3 py-2 text-white
                              shadow-[0_12px_30px_-20px_rgba(37,99,235,0.8)]">
                          ...
                          ${seller.seller?.buyOrder?.buyer?.walletAddress === address
                          ? 'border-blue-200/70 bg-white/70 rounded-lg px-2'
                          : 'border-zinc-300'}
                          `}>
                            <Image
                              src="/icon-buyer.png"
